# Guided Tour Companion Drone — Companion (Python) Module

This module contains the Python-based mission logic, drone control scripts, and utilities for the companion drone system.

## Overview

This project simulates a companion drone system for guided tours, enabling tour guides to ensure group safety and maintain regulation-compliant experiences. The tour guide can control the drone fleet using the [Companion Mobile App](https://github.com/NafieAlhilaly/guided-tour-companion-app).

The project uses [Ultralytics](https://www.ultralytics.com/) Pose model to detect falls (and other poses), via the service: https://github.com/NafieAlhilaly/ultralytics-pose-service
